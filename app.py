...
from langchain_openai import OpenAIEmbeddings  # Choose one import source for OpenAIEmbeddings
...
def create_vector_embedding():
    if "vectors" not in st.session_state:
        ...
        st.session_state.vectors = InMemoryVectorStore.from_documents(st.session_state.final_documents, st.session_state.embeddings)
...
if prompt:
    ...
    # Document similarity search with expander
